...
export type TabType = 'board' | 'backlog' | 'teams' | 'automations' | 'analytics'
...
export const BOARD_COLUMNS = [
  { id: 'BACKLOG', label: 'Backlog', dot: 'bg-slate-400', columnBg: 'bg-slate-50/30' },
  { id: 'TODO', label: 'To Do', dot: 'bg-blue-500', columnBg: 'bg-blue-50/10' },
  { id: 'IN_PROGRESS', label: 'In Progress', dot: 'bg-amber-500', columnBg: 'bg-amber-50/10' },
  { id: 'REVIEW', label: 'In Review', dot: 'bg-violet-500', columnBg: 'bg-violet-50/10' },
  { id: 'DONE', label: 'Done', dot: 'bg-emerald-500', columnBg: 'bg-emerald-50/10' },
]
