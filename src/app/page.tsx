...
// 1. FONTS (Modern SaaS Look)
// Plus Jakarta Sans is geometric and punchy for headings.
...
export default function LandingPage() {
  return (
    <div className={`min-h-screen bg-white text-neutral-900 selection:bg-neutral-900 selection:text-white ${jakarta.variable} ${inter.variable} font-sans overflow-x-hidden`}>
        ...
        <div className="max-w-[1400px] w-full">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
               ...
               <div className='mt-14'>
                ...
                {/* <div className="relative w-full mt-12 lg:mt-0 flex items-center justify-center"> */}
                     <CardStackWidget />
      ...
      {/* Custom Styles for Button Shimmer */}
      <style jsx global>{`
        @keyframes shimmer {
