...
export const HeroLeftColumn = () => {
  ...
  return (
    <div className="max-w-xl mx-auto lg:mx-0 relative z-10 flex flex-col items-center lg:items-start text-center lg:text-left pt-10 lg:pt-0">
        ...
        {/* 1. SYSTEM BADGE (Technical Look) */}
        <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5 }}
            className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white border border-neutral-200 shadow-sm mb-8 hover:border-neutral-300 transition-colors cursor-default"
        >
        ...
        {/* 2. HEADLINE (Mixed Weights for Impact) */}
        <motion.h1 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        {/* 3. SUBTEXT (Structured Description) */}
        <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        >
            ...
            <div className="relative group">
                ...
                <input 
                    ...
                    placeholder="github.com/Adityazzzz"
                    value={repoUrl}
        ...
        {/* 5. TECH SPECS FOOTER (Credibility) */}
        <motion.div 
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
